...
$rolUsuario = "profesor";
$sql = "SELECT nombre, apellido, correo, telefono, cedula FROM profesor";
$res = $conn->query($sql);
...
<body>
  ...
  <section class="home-section">
    ...
    while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
        echo "<div>";
        echo "<div class='text'>Nombre: {$row['nombre']}</div>";
        echo "<div class='text'> {$row['apellido']}</div></br>";
        echo "<div class='text'>Correo: {$row['correo']}</div></br>";
        echo "<div class='text'>Matricula:{$row['cedula']}</div></br>";
        echo "<div class='text'>Usuario:$nombreUsuario</div>";
        echo "</div>";
    }
    ?>
</section>
